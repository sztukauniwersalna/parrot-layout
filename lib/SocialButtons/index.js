...
function SocialButtons() {
    return (React.createElement("ul", { className: s.socialButtons },
        ...
        React.createElement("li", { key: 'youtube' },
            React.createElement(Button_1.default, { variant: 'action', color: 'green', url: 'https://www.youtube.com/channel/UCkFoI7DqK6OsofJlzv8PQPw' },
                React.createElement(Icon_1.default, { name: 'youtube' })))));
}
