...
var FacebookLike_1 = __webpack_require__(39);
...
var Feed_1 = __webpack_require__(42);
...
var Recipe_1 = __webpack_require__(44);
...
var gtag_1 = __webpack_require__(49);
...
Object.defineProperty(exports, "__esModule", { value: true });
var React = __webpack_require__(0);
var DeferredScript_1 = __webpack_require__(47);
var DeferredLink_1 = __webpack_require__(48);
function Root(_a) {
    var website = _a.website,
        page = _a.page,
        localBundles = _a.localBundles,
        externalBundles = _a.externalBundles;
    return React.createElement("html", null, React.createElement("head", null, React.createElement("title", null, page.title, " | ", website.title), React.createElement("meta", { name: 'path', content: page.url }), React.createElement("meta", { name: 'keywords', content: page.tags.join(', ') }), React.createElement("meta", { name: 'description', content: page.description }), React.createElement("meta", { name: 'viewport', content: 'width=device-width; initial-scale=1.0' }), React.createElement("script", { async: true, type: 'text/javascript', src: "https://www.googletagmanager.com/gtag/js?id=" + global.GA_TRACKING_ID }), React.createElement("script", { type: 'text/javascript', src: getGtagConfigBundle(localBundles.js) }), localBundles.css.map(function (url) {
        return React.createElement("link", { type: 'text/css', rel: 'stylesheet', href: url, key: url });
    }), React.createElement("meta", { property: 'og:url', content: "" + website.baseUrl + page.url }), React.createElement("meta", { property: 'og:title', content: page.title }), page.image !== null ? React.createElement("meta", { property: 'og:image', content: page.image }) : null, React.createElement("meta", { property: 'og:description', content: page.description }), React.createElement("meta", { property: 'og:locale', content: website.locale }), React.createElement("meta", { property: 'og:type', content: page.url === '/' ? 'website' : 'article' })), React.createElement("body", null, React.createElement("div", { id: 'root' }, "%%%BODY%%%"), externalBundles.js.map(function (url) {
        return React.createElement(DeferredScript_1.default, { src: url, key: url });
    }), removeGtagConfigBundle(localBundles.js).map(function (url) {
        return React.createElement(DeferredScript_1.default, { src: url, key: url });
    }), externalBundles.css.map(function (url) {
        return React.createElement(DeferredLink_1.default, { href: url, rel: 'stylesheet', key: url });
    })));
}
exports.Root = Root;
...
function sendPageviewOnLocationChange() {
    ...
    global.setInterval(function () {
        ...
        gtag('config', global.GA_TRACKING_ID, { page_path: page_path });
    }, 300);
}
