...
Object.defineProperty(exports, "__esModule", { value: true });
var React = __webpack_require__(0);
var DeferredScripts_1 = __webpack_require__(47);
var DeferredStyles_1 = __webpack_require__(48);
var GTAG_API_URL = "https://www.googletagmanager.com/gtag/js?id=" + "";
function Root(_a) {
    var website = _a.website,
        page = _a.page,
...
function DeferredScripts(_a) {
    var srcs = _a.srcs;
    return (React.createElement("script", { type: 'text/javascript', dangerouslySetInnerHTML: { __html: loadScripts.toString() + "\nloadScripts(" + JSON.stringify(srcs) + ");" } }));
}
exports.DeferredScripts = DeferredScripts;
exports.default = DeferredScripts;
// Must not have any side-effects as it is toString-ed.
...
function DeferredStyles(_a) {
    var hrefs = _a.hrefs;
    return (React.createElement("script", { type: 'text/javascript', dangerouslySetInnerHTML: { __html: loadStyles.toString() + "\nloadStyles(" + JSON.stringify(hrefs) + ");" } }));
}
...
function sendPageviewOnLocationChange() {
    ...
    global.setInterval(function () {
        ...
        gtag('config', "", { page_path: page_path });
    }, 300);
}
