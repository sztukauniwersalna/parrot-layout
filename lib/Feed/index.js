...
var Link_1 = require("paramorph/react/Link");
var s = require('./style');
;
...
var Feed = /** @class */ (function (_super) {
    ...
    Feed.prototype.isOnLastPage = function () {
        ...
        var lastPageNumber = Math.round(posts.length / pageSize);
    ...
    Feed.prototype.getPreviousUrl = function () {
        ...
        var pageNumber = Number.parseInt(pathParams.get(PAGE_PATH_PARAM));
