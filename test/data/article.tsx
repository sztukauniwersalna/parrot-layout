...
export function ArticlePage() {
  return (
    <div>
      <p>
        W ujęciu kosmicznym, qi jest fundamentalną esencją przedmiotów materialnych.
        Qi przenika cały <a href='https://pl.wikipedia.org/wiki/Wszech%C5%9Bwiat'>Wszechświat</a>,
        stanowiąc podstawę, z której tworzy się materia. Jako że w filozofii chińskiej kluczowym
        atrybutem natury jest zmienność, czy też przemiana, pustka cyklicznie zamienia się w formę,
        a forma w pustkę. Idea ta jest zobrazowana w symbolu 太極圖 (Taiji tu) oznaczającym
      ...
      <img
        alt='Yin Yang Symbol'
        src='https://upload.wikimedia.org/wikipedia/commons/1/17/Yin_yang.svg'
      />
    </div>
  );
}
